...
- Apresentar o passo a passo durante a execução para obtenção da equação que representa o algoritmo de Random Forest. O modelo gerado será usado para determinar o valor da variável dependente em função dos valores das duas variáveis independentes (explicativas);
